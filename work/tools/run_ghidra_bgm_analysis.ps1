param(
    ...
    [string]$ProjectDirectory = (Join-Path $PSScriptRoot '..\analysis\ghidra_bgm'),
    [string]$ProjectName = 'GundamTacticsBgm'
)
...
$ghidraUserRoot = Join-Path $PSScriptRoot '..\analysis\ghidra_user_bgm'
...
& $headless $ProjectDirectory $ProjectName `
    ...
    -postScript BgmLoopAnalysis.java `
    -deleteProject
