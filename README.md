...
『ガンダムタクティクス MOBILITY FLEET0079 復刻版』(2001年9月19日発売、Windows 95/98/Me 用) を Windows 11 上で遊べるようにする非公式の互換パッチのソースコードです。

## 対象

| 項目 | 内容 |
| --- | --- |
| タイトル | ガンダムタクティクス MOBILITY FLEET0079 復刻版 |
| 発売日 | 2001年9月19日 |
| ゲームの対応 OS | Windows 95/98/Me |
| パッチの動作環境 | Windows 11 |

対象はこの復刻版の `gundam.exe` だけです。インストーラーは `gundam.exe` の SHA256 を照合し、未改変の復刻版、またはこのパッチの既知のバージョンを当てたもの以外には適用しません。
